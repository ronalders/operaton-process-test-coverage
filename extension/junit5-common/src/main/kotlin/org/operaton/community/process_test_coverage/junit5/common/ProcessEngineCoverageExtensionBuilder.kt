 ...
 * #L%
 */
package org.operaton.community.process_test_coverage.junit5.common
...
abstract class ProcessEngineCoverageExtensionBuilder<T>(
    ...
    companion object {
         ...
         * `-Dorg.operaton.community.process_test_coverage.ASSERT_AT_LEAST=1.0`
         */
        const val DEFAULT_ASSERT_AT_LEAST_PROPERTY = "org.operaton.community.process_test_coverage.ASSERT_AT_LEAST"
