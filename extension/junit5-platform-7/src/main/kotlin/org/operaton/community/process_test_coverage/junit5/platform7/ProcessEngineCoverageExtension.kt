...
import org.operaton.community.process_test_coverage.junit5.common.ProcessEngineCoverageExtensionBuilder
import org.operaton.community.process_test_coverage.junit5.common.ProcessEngineCoverageExtensionHelper
    ...
    data class Builder(
        ...
        @Deprecated("Pass the configuration resource directly when creating the builder",
                ReplaceWith("ProcessEngineCoverageExtension.builder(configurationResource)",
                        "org.operaton.community.process_test_coverage.junit5.ProcessEngineCoverageExtension"))
