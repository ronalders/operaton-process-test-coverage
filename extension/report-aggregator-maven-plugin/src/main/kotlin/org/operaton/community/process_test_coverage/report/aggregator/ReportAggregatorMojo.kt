 ...
 * #L%
 */
package org.operaton.community.process_test_coverage.report.aggregator
...
import org.operaton.community.process_test_coverage.core.export.CoverageStateJsonExporter.combineCoverageStateResults
import org.operaton.community.process_test_coverage.core.export.CoverageStateJsonExporter.createCoverageStateResult
import org.operaton.community.process_test_coverage.core.export.CoverageStateJsonExporter.readCoverageStateResult
...
class ReportAggregatorMojo : AbstractMojo(), MavenReport {
    ...
    companion object {
        var TARGET_DIR_ROOT: String? = System.getProperty("operaton-process-test-coverage.target-dir-root")
    }
