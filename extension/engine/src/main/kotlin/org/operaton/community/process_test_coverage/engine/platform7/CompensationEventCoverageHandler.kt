 ...
 *  limitations under the License.
 */
package org.operaton.community.process_test_coverage.engine.platform7
...
import org.operaton.community.process_test_coverage.core.model.Collector
import org.operaton.community.process_test_coverage.core.model.Event
import org.operaton.community.process_test_coverage.core.model.EventSource
import org.operaton.community.process_test_coverage.core.model.EventType
...
class CompensationEventCoverageHandler : CompensationEventHandler() {
    ...
    override fun handleEvent(
        eventSubscription: EventSubscriptionEntity,
        payload: Any,
        localPayload: Any,
        payloadToTriggeredScope: Any,
        businessKey: String,
