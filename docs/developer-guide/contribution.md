...
We'd love you to contribute to this project by filing bugs, helping others on the [issue tracker](https://github.com/camunda/operaton-process-test-coverage/issues), and by contributing features/bug fixes through pull requests.
...
Please use our [issue tracker](https://github.com/camunda/operaton-process-test-coverage/issues) for project communication.
...
1. git clone https://github.com/camunda/operaton-process-test-coverage.git
2. cd operaton-process-test-coverage/
3. mvn clean install
