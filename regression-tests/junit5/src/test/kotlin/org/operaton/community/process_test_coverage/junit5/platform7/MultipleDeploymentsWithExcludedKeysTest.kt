...
class MultipleDeploymentsWithExcludedKeysTest {
    ...
    companion object {
        ...
        @JvmField
        @RegisterExtension
        var extension: ProcessEngineCoverageExtension = ProcessEngineCoverageExtension.builder().excludeProcessDefinitionKeys("process-test-coverage").build()
    }
